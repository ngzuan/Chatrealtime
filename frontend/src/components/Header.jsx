...
function Header() {
  return (
    <div className="text-white z-50 flex items-center w-[100%] bg-homeColor_primary">
      <header className="grid lg:grid-cols-12 w-full px-6 lg:w-[1180px] md:grid-cols-9 md:px-10 sm:grid-cols-5 max-w-[1260px] lg:mx-auto gap-5 h-[80px]">
        ...
        <div className="flex items-center md:col-start-8 md:col-end-10 sm:col-start-4 sm:col-end-6 lg:col-start-11 lg:col-end-13 space-x-4 ml-auto ">
